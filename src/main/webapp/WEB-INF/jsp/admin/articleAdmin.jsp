...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath }/admin/articleAdmin.jhtml">
            <span>作者:</span>
            <input name="queryAuthorName" class="input-text" type="text" value="${queryAuthorName }">
            <span>文章标题:</span>
    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="article" items="${articleList}" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="view" href="${pageContext.request.contextPath }/article.jhtml/${article.authorId}/${article.id}"><img
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/articleAdmin.js"></script>
</body>
</html>
