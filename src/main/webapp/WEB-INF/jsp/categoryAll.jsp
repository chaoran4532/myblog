...
<head>
	...
	<title>${category.categoryName} | ${blogger.nickName}'s Blog</title>
		...
		<div class="col-md-3" id="left_content">
			...
			<div id="list">
				<table class="table table-hover c_center">
					...
					<tr>
						<td class="active"><a href="${pageContext.request.contextPath}/category.jhtml/${blogger.userId}"><span
			...
			<div class="col-md-7 " id="right_Content">
				...
				<div class="list-group">
					...
					<!-- 这里初始化列表 -->					
					<c:forEach var="map" items="${articleListMap}">
					<div class="sort_name">
					<!-- 分类名字 -->
					...
					<c:forEach var="article" items="${map.value}">
					<li class="list-group-item">
								<div>
									<div>
										<a href="${pageContext.request.contextPath}/article.jhtml/${blogger}/${article.id}">${article.title}</a>
									</div>
									<div class="c_right">
									<img src="${pageContext.request.contextPath}/img/time.png">
									${article.time}&nbsp;&nbsp;
									<span class="visit"><img src="${pageContext.request.contextPath}/img/visit.png">
									${article.visit}	</span>
									</div>
								</div>
					</li>
